...
AMDGPU_TARGET="$(rocminfo | grep -o 'gfx[0-9a-z]*' | sort -u | head -1)"
...
# Uses the system ROCm install (expected at /opt/rocm, preinstalled on
# DigitalOcean's AI/ML-ready AMD GPU Droplet image).
